...
def test_contains_all_basic():
    ...
    eval = ContainsAll(field="text", value=["apple", "banana"])
...
def test_contains_all_missing_terms():
    ...
    eval = ContainsAll(field="text", value=["apple", "banana", "orange"])
    result = eval(text="I have an apple and a banana")
...
def test_contains_all_empty_input():
    ...
    eval = ContainsAll(field="text", value=["apple"])
    result = eval(text="")
    assert not result.passed
...
def test_contains_all_missing_field():
    ...
    eval = ContainsAll(field="missing_field", value=["apple"])
...
def test_contains_all_empty_values():
    ...
    eval = ContainsAll(field="text", value=[])
...
def test_contains_all_non_string_values():
    ...
    eval = ContainsAll(field="text", value=[123, True])
